...
BOOL CGSIServerDlg::OnInitDialog()
{
	...
	WSADATA wsadata;
	WSAStartup(0x0202, &wsadata);  // ws2_32. Dll 을 사용하기 위해 초기화 한다.
...
void CGSIServerDlg::OnDestroy()
{
	...
	WSACleanup();  // ws2_32.dll 의 사용을 중단한다.
}
